    ...
    <div className='bordercenter'>
      <div className='borderpay'>
        <div style={{textAlign:'center'}}>
          <p className='textpay'>No Pembayaran 
          <h5 style={{fontWeight: 'bold', fontSize: '20px'}}>INV-123456789101112</h5> 
          </p>
          <p>Total Pembayaran Donasi
          <h2 style={{fontWeight:'bold'}}>Rp 20.000</h2>
          <button className='tombolpayatas'><VscCopy/>Salin Nominal</button>
          </p>
        </div>
        <div style={{borderStyle:'solid', height:'32px', borderLeft:'none', borderRight:'none'}}>
          <ul className='ulpay'>
        ...
        <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
        <p className='ketpay'>Donasi akan kadaluwarsa 23 jam dari sekarang, 
        Selesaikan pembayaran donasi sebelum 30 Jan 2023, pukul 16:26</p>
        </div>
        <h5 style={{textAlign:'center'}}>Silahkan Transfer Ke</h5>
        <div style={{borderStyle:'solid', height:'95px', borderLeft:'none', borderRight:'none'}}>
          <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
